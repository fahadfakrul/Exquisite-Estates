...
const Footer = () => {
  return (
    <footer className="py-6 mt-28 dark:bg-gray-100 dark:text-gray-900">
      ...
      <div className="container px-6 mx-auto space-y-6  dark:divide-gray-600 md:space-y-12 divide-opacity-50">
            ...
            <ul>
              <li>
                <a
                  rel="noopener noreferrer"
                  href="#"
                  className="hover:dark:text-gray-700 text-gray-500"
                >
                  Apartment
                </a>
              </li>
            ...
            <ul>
              <li>
                <a
                  rel="noopener noreferrer"
                  href="#"
                  className="hover:dark:text-gray-700 text-gray-500 flex items-center gap-2"
                >
                  <FaBuilding />2133 Commercial St AB Avenue
                </a>
              </li>
              <li>
                <a
              ...
              <li>
                <a
                  ...
                  className="hover:dark:text-gray-700 text-gray-500 flex items-center gap-2"
                >
                 <FaEnvelope /> exquisiteestaes@gmail.com
                </a>
              </li>
              <li>
                <a
        ...
        <div className="grid justify-center pt-6 lg:justify-between">
          <div className="flex flex-col self-center text-sm text-center md:block lg:col-start-1 md:space-x-6">
            <span>Exquisite Estaes ©2024 All rights reserved</span>
          ...
          <div className="flex justify-center pt-4 space-x-4 lg:pt-0 lg:col-end-13">
            <a
              ...
              href="#"
              title="Email"
              className="flex items-center justify-center w-10 h-10 rounded-full hover:text-gray-700 dark:text-black"
            >
              <svg
