        ...
        <div>
            <div className="flex space-x-6">
				...
				<div className="flex flex-col">
					...
					<p className="text-lg w-28 h-60 dark:text-gray-600">{address}</p>
                    ...
                    <Link to={ `/consultantdetails/${id}`}><button className="btn mt-3 text-white bg-[#418397]"  onClick={handleProperty}>View Details</button> </Link>
				</div>
			</div>
        </div>
    );
